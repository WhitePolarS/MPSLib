...
import numpy as np
from entity.Coords import Coords
from entity.MPSAlgorithm import MPSAlgorithm
...
class SNESIM(MPSAlgorithm):
    ...
    def _constructTemplateFaces(self, size_x, size_y, size_z):
        ...
        print("模板的中心x:{} y:{} z:{}".format(template_center_x, template_center_y, template_center_z))
        ...
        print("14:实际走的模板路径为：{}".format(template_path))
        # 循环通过所有的模板指数
        # 初始化faces
        ...
        for i in range(0, total_template_indices):
            ...
            print("第{}个遍历的点相对于模板中心的位置为{}".format(i + 1, self._template_faces[i].coords2String()))
